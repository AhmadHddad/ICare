...
export default function PatientStatistics({
  ...
  const renderDesc = (desc, showAll) => (
    <Typography
      color="textPrimary"
      className={`${!showAll && classes.desc} ${
        showAll && classes.expandedDesc
      }`}
    >
        ...
        >
          ...
          >
            ...
            <ITable
              ...
              tableContainerProps={{ classes: { root: classes.tablePaper } }}
              paperProps={{
                classes: { root: `${classes.tablePaper} ${classes.paperProps}` }
              }}
            />
          </Grid>
          <Grid
          ...
          >
            ...
            <ITable
              ...
              tableContainerProps={{ classes: { root: classes.tablePaper } }}
              paperProps={{ classes: { root: classes.tablePaper } }}
            />
          </Grid>
        </Grid>
      </CardContent>
